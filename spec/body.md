...
| `validated` | Every applicable check of [Consumer Requirements](#consumer-requirements) items 1–10 has passed. | `accepted`, `errored` | — | **Nothing.** Validation is internal to the *consumer* and is never signaled on the wire. |
